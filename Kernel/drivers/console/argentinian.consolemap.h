static struct language_mapping ar_mapping =
	{
		...
		.shift_map = {"\x1b" /*escape*/, "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "\x7f" /*backspace*/, "\x09" /*tab*/, "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "{", "}", "\x0d" /*enter*/, STATE_CHANGE_KEY, /*crtl*/
					  "A", "S", "D", "F", "G", "H", "J", "K", "L", ":", "\"", "|", STATE_CHANGE_KEY,																																	   /*shift left*/
					  UNDEF, "Z", "X", "C", "V", "B", "N", "M", "<", ">", "?", STATE_CHANGE_KEY,																																		   /*shift right*/
